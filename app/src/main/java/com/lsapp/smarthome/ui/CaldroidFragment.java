...
public class CaldroidFragment extends DialogFragment {
    ...
    public void restoreDialogStatesFromKey(FragmentManager manager,
        ...
        com.roomorama.caldroid.CaldroidFragment existingDialog = (com.roomorama.caldroid.CaldroidFragment) manager
     ...
     * @return
     */
    public static com.roomorama.caldroid.CaldroidFragment newInstance(String dialogTitle, int month,
                                                                      int year) {
        com.roomorama.caldroid.CaldroidFragment f = new com.roomorama.caldroid.CaldroidFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        monthTitleTextView = (TextView) view
                .findViewById(com.caldroid.R.id.calendar_month_year_textview);

        // For the left arrow button
        leftArrowButton = (Button) view.findViewById(com.caldroid.R.id.calendar_left_arrow);
        ...
        weekdayGridView = (GridView) view.findViewById(com.caldroid.R.id.weekday_gridview);
    ...
    public class DatePageChangeListener implements OnPageChangeListener {
        ...
        private int getNext(int position) {
            return (position + 1) % com.roomorama.caldroid.CaldroidFragment.NUMBER_OF_PAGES;
        }
        ...
        private int getPrevious(int position) {
            return (position + 3) % com.roomorama.caldroid.CaldroidFragment.NUMBER_OF_PAGES;
        }
        ...
        public int getCurrent(int position) {
            return position % com.roomorama.caldroid.CaldroidFragment.NUMBER_OF_PAGES;
        }
        ...
        public void onPageSelected(int position) {
            ...
            CaldroidGridAdapter currentAdapter = caldroidGridAdapters
                    .get(position % com.roomorama.caldroid.CaldroidFragment.NUMBER_OF_PAGES);
